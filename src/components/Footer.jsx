    ...
    <div className="w-full bg-button h-auto">
      <Link to="/" onClick={handleClick}>
        <div className="flex absolute right-44 mt-[-45px] bg-[#8BA99C] p-5 rounded-full">
          <img src={iconFooter || "/placeholder.svg"} alt="Ícono Footer" />
        </div>
      </Link>
      <div className="containerWidth flex justify-around py-10">
        <div className="flex flex-col justify-start items-start gap-3">
          <img src={logoFooter || "/placeholder.svg"} alt="Logo Footer" />
          <p className="font-firelli text-[#F4EAE2]">
            {configuracion?.email || "alberdiserviciosas@gmail.com"}
          </p>
          <p className="font-firelli text-[#F4EAE2]">
            {configuracion?.direccion || "Alberdi 648 (0) San Juan, Argentina"}
          </p>
        </div>
